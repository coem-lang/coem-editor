...
})({"kKFYN":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3eb7bf1e56c5e9e4";
...
var _setupJs = require("./codemirror/setup.js");
const menuBtns = document.querySelectorAll(".nav__item > button"), outputArea = document.querySelector(".output"), consoleArea = document.querySelector(".console"), filenameTitle = document.querySelector("h2 .filename-title"), tocItems = document.querySelector(".toc__items"), tocBtns = document.querySelectorAll(".toc__item button"), newBtn = document.querySelector("#newBtn"), reflectBtn = document.querySelector("#reflectBtn");
let editor, isMenuOpen = false, currentTitle = "Untitled", output = "";
// MENU
...
function onMenuBtnMouseover(e) {
    ...
    let btn = e.currentTarget;
    if (isMenuOpen) {
        for (let b of menuBtns)b.parentElement.classList.remove("nav__item--open");
...
function clear() {
    _setupJs.view.dispatch({
        changes: {
            from: 0,
            to: _setupJs.view.state.doc.length,
            insert: ""
        }
    });
    outputArea.innerHTML = "";
    for (let btn of tocBtns)btn.parentElement.classList.remove("current");
}
...
function reflect() {
    ...
    const source = _setupJs.view.state.doc.toString();
    console.log(source);
...
navToggle.addEventListener("click", (e)=>{
    e.preventDefault();
    if (nav.classList.toggle("open")) navToggle.innerText = "×";
    else navToggle.innerText = "☰";
    document.body.classList.toggle("navIsOpen");
});

},{"./codemirror/setup.js":"2qpg6"}]},["kKFYN","goJYj"], "goJYj", "parcelRequire34c6")

//# sourceMappingURL=index.56c5e9e4.js.map
